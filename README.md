...
* [Lab 9 - Configure Kudu and Impala](#configure-kudu-and-impala)
* [Lab 10 - Using NiFi to populate data from Kafka to Kudu](#using-nifi-to-populate-the-data-from-kafka-to-kudu)
